    ...
    <div class="container py-5">
        <div class="card shadow-lg border-0 mx-auto" style="max-width: 1200px; width: 100%; border-radius: 1rem;">
            <div class="card-header bg-success text-white text-center py-4" style="border-radius: 1rem 1rem 0 0;">
                <h2 class="fw-bold mb-0">Add a New Waste ♻️</h2>
            </div>
                ...
                <form action="{{ route('wastes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="collection_point_id" id="collection_point_id" value="{{ old('collection_point_id') }}" class="form-control" required>
                        </div>
                    ...
                    <div class="text-center mt-5">
                        ...
                        <button type="submit" class="btn btn-success px-4">
                            <i class="bi bi-save me-1"></i> Save Waste
                        </button>
                    </div>
                </form>
            </div>
