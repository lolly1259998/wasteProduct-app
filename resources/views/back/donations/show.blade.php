    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-body">
                    <h1 class="h3 font-weight-bold mb-4 text-success text-center">Donation #{{ $donation->id }}</h1>
                    @if (session('success'))
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex flex-wrap gap-2 mt-2">
                                    @foreach($donation->images as $image)
                                        <img src="{{ Storage::url($image) }}" alt="Donation Image" class="img-thumbnail" style="width: 200px; height: auto;">
                                    @endforeach
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4 gap-2">
                        <div class="d-flex gap-2">
                            <a href="{{ route('back.donations.index') }}" class="btn btn-secondary">Back</a>
                            <a href="{{ route('back.donations.edit', $donation) }}" class="btn btn-warning">Update</a>
                        </div>
