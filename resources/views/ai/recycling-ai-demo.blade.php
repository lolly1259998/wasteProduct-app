                ...
                <div class="card-body">
                    <form id="classify-form">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3" placeholder="Detailed description of the waste..."></textarea>
                        </div>
                    ...
                    <form id="quality-form">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="recycling_method" required>
                                ...
                                <option value="Fusion and molding">Fusion and molding</option>
