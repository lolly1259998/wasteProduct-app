...
@section('content')
<form method="POST" action="{{ route('manage.categories.store') }}" class="mx-auto max-w-xl space-y-4 rounded-xl border border-gray-700 bg-gray-800/60 p-6">
    @csrf
    <div>
    ...
    <div class="flex justify-end gap-2">
        ...
        <button type="submit" class="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-black hover:bg-emerald-500">Create</button>
    </div>
</form>
@endsection
