...
use App\Models\Waste;  // Fixed: APP → App
use App\Models\CollectionPoint;  // Fixed: app → App
...
use App\Http\Controllers\Backoffice\ProductController as BackofficeProductController;  // Alias to avoid conflict
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('back')->name('back.')->group(function () {
        ...
        Route::post('products/{id}/toggle-availability', [BackofficeProductController::class, 'toggleAvailability'])
...
Route::get('/dashbored/collectionpoints', [CollectionPointController::class, 'index'])->name('collectionpoints.index');
